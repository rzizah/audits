...
| ID                                                                                                                                                          | Title                                                                                                                                              | Severity |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | -------- |
| [C-01](#h-01-staking-contract-is-vulnerable-to-inflation-attack-making-malicious-1st-staker-grief-the-following-stakers)                                          | staking contract is vulnerable to inflation attack making malicious 1st staker Grief the following stakers                                         | Critical |

## [C-01] staking contract is vulnerable to inflation attack making malicious 1st staker Grief the following stakers
